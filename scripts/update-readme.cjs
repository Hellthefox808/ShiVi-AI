...
- **Evaluation Test Categories**:
  ...
  - **Groundedness & Citations**: Zero hallucination scorecards (Target: $\ge 98\%$).
...
console.log('Successfully updated README.md with comprehensive B2B RevOps specifications.');
